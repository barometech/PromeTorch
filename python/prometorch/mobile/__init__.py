"""
prometorch.mobile — ExecuTorch-like compact on-device inference format.
"""
...
def export(model, example_input, path: str) -> bool:
    ...
    try:
        from prometorch._C import mobile_export as _cpp
        return bool(_cpp.export(model, example_input, path))
    except (ImportError, AttributeError):
        raise RuntimeError(
            "prometorch.mobile.export requires _C to be built with "
