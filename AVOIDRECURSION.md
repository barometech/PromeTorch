...
Аудит инфраструктуры: `INFRASTRUCTURE_AUDIT.md`
...
| Что | Количество |
|-----|------------|
| Build директорий | **39 штук** |
| Log файлов (.txt) | **195 штук** |
| Batch файлов (.bat) | **199 штук** |
...
3. **НЕ создавать новые build директории** - их уже 39
4. **НЕ создавать новые batch файлы** - их уже 199
...
**MNIST accuracy: 12-15% вместо 49%** — РЕШЕНО (2026-03-02). Текущая accuracy: 97.65%
