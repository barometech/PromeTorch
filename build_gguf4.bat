...
cd /d C:\Users\USER\Desktop\promethorch\build_final3
nmake test_gguf_inference > C:\Users\USER\Desktop\promethorch\build_gguf_log.txt 2>&1

echo EXIT_CODE=%ERRORLEVEL% >> C:\Users\USER\Desktop\promethorch\build_gguf_log.txt
if exist examples\gguf\test_gguf_inference.exe (
    echo BUILD_SUCCESS >> C:\Users\USER\Desktop\promethorch\build_gguf_log.txt
) else (
    echo BUILD_FAILED >> C:\Users\USER\Desktop\promethorch\build_gguf_log.txt
)
