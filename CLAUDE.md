...
cd build_pybind
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE=Release -DPT_BUILD_PYTHON=ON -DPT_BUILD_TESTS=OFF -DPT_USE_CUDA=OFF -DPYTHON_EXECUTABLE=C:\ProgramData\anaconda3\python.exe -DCMAKE_LIBRARY_OUTPUT_DIRECTORY=C:\Users\USER\Desktop\promethorch\python\promethorch
nmake _C
```
...
```batch
@echo off
set PATH=C:\Users\USER\Desktop\promethorch\build_cudnn;C:\ProgramData\anaconda3\Library\bin;%PATH%
cd /d C:\Users\USER\Desktop\promethorch\build_cudnn\examples\pir
echo Starting training... > C:\Users\USER\Desktop\promethorch\train_output.txt
train_pir.exe --data C:\Users\USER\Desktop\promethorch\data\shakespeare.txt --device cuda >> C:\Users\USER\Desktop\promethorch\train_output.txt 2>&1
echo Exit code: %errorlevel% >> C:\Users\USER\Desktop\promethorch\train_output.txt
```
...
### Структура проекта
```
C:\Users\USER\Desktop\promethorch\
...
### Запуск тренировки
```batch
cd C:\Users\USER\Desktop\promethorch\build_cpu\examples\pir
train_pir.exe --data C:\Users\USER\Desktop\promethorch\data\shakespeare.txt
```
...
**Директория:** `C:\Users\USER\Desktop\promethorch\build_verify\`
...
**Директория:** `C:\Users\USER\Desktop\promethorch\build_pycheck\`
...
```python
import sys
sys.path.insert(0, r'C:\Users\USER\Desktop\promethorch\python')
...
**Директория:** `C:\Users\USER\Desktop\promethorch\build_cuda_check\`
...
call "C:\Program Files (x86)\Microsoft Visual Studio\2019\BuildTools\VC\Auxiliary\Build\vcvarsall.bat" x64
set PATH=C:\ProgramData\anaconda3\Library\bin;C:\ProgramData\anaconda3\Scripts;%PATH%
cd /d C:\Users\USER\Desktop\promethorch\build_pycheck
nmake _C 2>&1
```
...
set PATH=C:\ProgramData\anaconda3\Library\bin;C:\ProgramData\anaconda3\Scripts;%PATH%
set CUDA_PATH=C:\ProgramData\anaconda3\Library
cd /d C:\Users\USER\Desktop\promethorch\build_cuda_check
nmake aten_cuda 2>&1
```
...
**Директория:** `C:\Users\USER\Desktop\promethorch\website\`

**Запуск локально:**
```batch
cd C:\Users\USER\Desktop\promethorch\website
...
**Сборка с cuDNN:**
```batch
cd C:\Users\USER\Desktop\promethorch\build_cuda_check
...
**Директория:** `C:\Users\USER\Desktop\promethorch\build_cudnn\`
...
set PATH=C:\ProgramData\anaconda3\Library\bin;C:\ProgramData\anaconda3\Scripts;%PATH%
set CUDA_PATH=C:\ProgramData\anaconda3\Library
cd /d C:\Users\USER\Desktop\promethorch\build_cudnn
nmake all
```
