// gelu_backward.cpp - Backward pass for GELU activation on NMC4
...
// GELU coefficient: 1.702 in Q16.16
#define GELU_COEF 111543

void apply_gelu_backward(
    ...
    for (unsigned int i = 0; i < count; i++) {
        ...
        fixed32 grad_in = gelu_backward(x, grad_out);
...
int main() {
    ...
    while (1) {
        ...
        if (mem[0] == 1) {
            ...
            apply_gelu_backward(input, grad_output, grad_input, count);
