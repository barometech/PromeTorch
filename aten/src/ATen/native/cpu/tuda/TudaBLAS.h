...
[[maybe_unused]] static void sgemm(
...
[[maybe_unused]] static void sgemm_nt(
    int64_t M, int64_t K, int64_t N,
    float alpha,
    const float* __restrict A, int64_t lda,
    const float* __restrict B, int64_t ldb,
...
[[maybe_unused]] static void sgemv(
    int64_t M, int64_t N,
    float alpha,
    const float* __restrict A, int64_t lda,
...
[[maybe_unused]] static float sdot(int64_t N, const float* __restrict x, const float* __restrict y) {
...
[[maybe_unused]] static void saxpy(int64_t N, float alpha, const float* __restrict x, float* __restrict y) {
    constexpr int W = VecF::width;
