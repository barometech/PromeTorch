...
```cmd
cd C:\Users\paper\Desktop\prometorch
...
cd /d C:\Users\paper\Desktop\prometorch
...
```batch
@echo off
set PATH=C:\Users\paper\Desktop\prometorch\build_cuda;C:\ProgramData\anaconda3\Library\bin;%PATH%
cd /d C:\Users\paper\Desktop\prometorch\build_cuda\examples\mnist
train_mnist_mlp.exe --data C:\Users\paper\Desktop\prometorch\data\mnist --device cuda --epochs 5 --batch_size 64
```
...
Путь: `C:\Users\paper\Desktop\prometorch\data\mnist\`
