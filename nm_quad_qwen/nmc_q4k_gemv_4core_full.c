/* nmc_q4k_gemv_4core.c — per-core kernel, M=8 rows per core.
 * 4 cores × 8 rows = 32 total rows.
 * Identical to nmc_q4k_gemv_fast.c but M=8.
 */
#include <stdio.h>
#include <math.h>
#include <string.h>
...
#define M_TOTAL 256
#define M_PER_CORE 64
#define K 2560
#define BLOCKS_PER_ROW (K / 256)
#define ROW_WORDS (BLOCKS_PER_ROW * 144)

/* Shared (cluster EMI) — host uploads once, all 4 cores read */
