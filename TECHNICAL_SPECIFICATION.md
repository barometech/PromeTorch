...
> ⚠ **ИСТОРИЧЕСКИЙ ДОКУМЕНТ (план от 2026-01-20).** Это исходное ТЗ с
> чек-боксами начала проекта; многое сделано/изменилось/переосмыслено.
> Актуальный статус — `STATS.md` (числа из кода), `README.md`, `docs/`.
> Сборка — `docs/BUILD.md`. Не использовать как источник текущего состояния.

**Версия документа:** 1.0 (архивный план)
**Дата:** 2026-01-20
