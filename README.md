...
**1. Технологический суверенитет.** Единственный фреймворк глубокого обучения с нативной поддержкой Эльбрус (МЦСТ), NM Card Mini (partner), Байкал-М/С (Байкал Электроникс). Не порт PyTorch — написан с нуля, без зависимости от зарубежного кода.
...
Сервер МЦСТ &lt;private MCST server&gt; — 4x Elbrus-MCST E8C2 (VLIW), 32 ядра, 1500 MHz.
...
| **partner** | NM Card Mini K1879VM8YA | NeuroMatrix DSP | NMCard | Эмулятор + реальное железо |
