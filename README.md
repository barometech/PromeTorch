...
**LLM inference — qwen3:4b Q4_K_M (2026-04-30):**
...
| PromeTorch 4-proc TP + Q8 SoA4 QKV+gate_up | 28/32 | 6.4 | ×12.9 |
...
**TP-4 SoA — лучший конфиг.** Q8 SoA4 — 4-row interleaved INT8 layout под `qpmaddubsh`
(VNNI-style INT8 MAD на e2k v5), репакуется при загрузке из Q4_K блоков. Запуск:
