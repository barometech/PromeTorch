...
e16c.ru E16C, Темиксов 8C/4C). MCST публичный manual описывает API,
...
- TP-8 (или TP-16 на full E16C, нам Темикс выделил 8/16 ядер)
...
- [ ] Минимальная версия LCC для каждого intrinsic (важно — Темикс на
