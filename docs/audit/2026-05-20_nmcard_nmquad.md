...
12. Qwen3-4B port в `nm_quad_qwen/` **не использует** `aten/src/ATen/nmcard/` infrastructure. Стоит отдельно, runs на NM Quad host x86 (Linux, ssh elbrus-user@NMQUAD_HOST).
