...
Already done at startup (`gguf_loader.h:319`). On ELBRUS_HOST only **256 of 1191 needed** hugepages are reserved. Remaining 935 / 4 = 234 layers' worth of weights live in 4-KB pages. To enable more we'd need root + sysctl, **not a software change**. JOURNAL 2026-04-21 confirms PT_HUGETLB=1 produced **0% gain** (even regressed 4.8 → 4.6 tok/s). Reject.
